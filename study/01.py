...
img1=cv2.imread('card4.jpg')
gray1 = cv2.cvtColor(img1, cv2.COLOR_BGR2GRAY)
img2 = cv2.imread('cards.jpg')  # 장면 영상
...
img_match_resized = cv2.resize(img_match, (img_match.shape[1] // 8, img_match.shape[0] // 8))

cv2.imshow('Matches and Homography', img_match_resized)
