...
def construct_yolo_v3():
    f=open('coco_names_kor.txt', 'r', encoding='UTF-8') #한글인 경우에는 2~3바이트로 읽어줘야 함
...
while True:
    ...
    img_pill = Image.fromarray(frame) #한글
    draw = ImageDraw.Draw(img_pill) #한글
